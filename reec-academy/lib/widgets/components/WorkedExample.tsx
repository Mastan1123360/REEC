 ...
 * "Run" affordance that opens the real Code Workspace (right-side panel,
 * backed by app/api/compile — a genuine Rust compiler, not a placeholder)
 * pre-filled with this block's actual source, extracted server-side by
 * the parser (block.codeSource).
 */
    ...
    >
      <div className="relative">
        ...
        <button
          ...
          title={hasRunnableCode ? "Open in Code Workspace" : "No runnable code block found in this example"}
          onClick={() => hasRunnableCode && openWorkspace(block!.codeSource!, label)}
        >
          <Play size={12} /> Run
        </button>
      </div>
