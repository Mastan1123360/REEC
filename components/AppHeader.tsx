  ...
  return (
    <div className="flex items-center gap-2 sm:gap-2.5">
      ...
      <button
        ...
        className="group flex w-36 sm:w-52 lg:w-60 items-center gap-2 rounded-xl border border-slate-900/[0.06] dark:border-white/[0.08] bg-white/60 dark:bg-white/[0.05] px-3 py-1.5 text-xs text-slate-500 dark:text-slate-400 shadow-xs backdrop-blur-xl transition-all hover:border-blue-500/40 dark:hover:border-blue-400/30 hover:bg-white/90 dark:hover:bg-white/[0.09] hover:text-slate-800 dark:hover:text-slate-200 active:scale-[0.98]"
        style={{
      ...
      >
        <Search
          size={13}
          className="shrink-0 text-slate-400 dark:text-slate-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors"
        />
      ...
      <button
        ...
        className="relative flex h-8 w-8 items-center justify-center rounded-xl border border-slate-900/[0.06] dark:border-white/[0.08] bg-white/60 dark:bg-white/[0.05] text-slate-600 dark:text-slate-400 shadow-xs backdrop-blur-xl transition-all hover:text-slate-900 dark:hover:text-slate-100 hover:bg-white/90 dark:hover:bg-white/[0.09] hover:border-blue-500/40 dark:hover:border-blue-400/30 active:scale-95 overflow-hidden"
        style={{
          boxShadow: "var(--glass-inner-highlight)",
        }}
      >
...
function getRouteLabel(pathname: string): { title: string; subtitle?: string } {
  ...
  if (pathname.startsWith("/upload")) return { title: "Author Module", subtitle: "Markdown Ingestion" };
...
export function AppHeader({
  ...
  return (
    <header
      className="h-14 lg:h-16 shrink-0 flex items-center justify-between px-4 sm:px-6 lg:px-8 border-b border-slate-900/[0.06] dark:border-white/[0.07] bg-white/45 dark:bg-[#070c18]/65 backdrop-blur-2xl backdrop-saturate-180 z-20"
      style={{
