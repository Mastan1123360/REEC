    ...
    >
      <div>
        ...
        <div className="flex items-start gap-2.5 pt-0.5">
          {/* Blue icon badge */}
          <div
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-blue-500/35 bg-blue-500/10 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 shadow-xs backdrop-blur-md"
            style={{
